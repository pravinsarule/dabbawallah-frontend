      ...
      <div className="max-w-7xl mx-auto px-6 mt-24">
        <div className="promo-banner rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-4">
            <Link href="/services/packages" className="btn-white">
              View Monthly Plans <FaArrowRight />
            </Link>
            <Link href="/contact" className="bg-black/20 backdrop-blur-md text-white border border-white/30 px-8 py-3.5 rounded-full font-bold hover:bg-black/30 transition-all flex items-center justify-center gap-2">
              Order in Bulk
            </Link>
          </div>
        </div>
