    ...
    <footer style={{ background: "#1A0A00" }} className="text-gray-300">
      ...
      <div style={{ background: "linear-gradient(135deg, #FF6B35, #C9420A)" }} className="py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <Link href="/menu" className="btn-white whitespace-nowrap text-sm">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i}>
                  <Link href={l.path || "/"} className="text-gray-400 hover:text-saffron-400 text-sm transition-colors">
                    {l.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-[11px] text-gray-500 font-bold">
            <Link href="/Faqs" className="hover:text-saffron-400 transition-colors">Privacy</Link>
            <Link href="/Faqs" className="hover:text-saffron-400 transition-colors">Terms</Link>
            <Link href="/Faqs" className="hover:text-saffron-400 transition-colors">Refunds</Link>
          </div>
        </div>
      </div>
    </footer>
