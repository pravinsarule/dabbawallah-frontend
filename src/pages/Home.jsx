        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-5 animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
              <Link to="/menu" className="bg-white text-saffron-600 px-8 py-4 rounded-2xl font-black text-lg hover:scale-105 hover:shadow-2xl transition-all flex items-center gap-2 transform">
                🍱 Order Now <FaArrowRight />
              </Link>
              <Link to="/register" state={{ role: 'vendor' }} className="bg-orange-900/30 backdrop-blur-md border-2 border-white/60 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/20 transition-all">
                Partner With Us
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={ref} className={`transition-all duration-1000 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="text-center mt-10">
            ...
            <Link to="/services/packages" className="btn-primary inline-flex">
    ...
    <section className="py-24 px-4 overflow-hidden" style={{ background: "#FFF8F0" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 promo-banner rounded-3xl p-8 text-white text-center shadow-2xl">
          ...
          <Link to="/register" className="btn-white inline-flex">
    ...
    <section className="py-24 px-4 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-4">
          ...
          <Link to="/menu" className="btn-outline self-start md:self-end">
          ...
          <div className="promo-banner rounded-3xl p-12 text-white text-center mb-8 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link to="/services/packages" className="border-2 border-white/40 text-white px-8 py-3.5 rounded-full font-bold hover:bg-white/10 transition-all inline-flex items-center gap-2">
                  View All Plans
                </Link>
              </div>
            </div>
          ...
          <div className="bg-gray-900 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <Link to="/about" className="border border-gray-600 text-gray-300 px-6 py-3 rounded-full font-semibold text-sm hover:border-saffron-500 hover:text-saffron-400 transition-all inline-flex items-center gap-2">
                  Learn How It Works
                </Link>
              </div>
