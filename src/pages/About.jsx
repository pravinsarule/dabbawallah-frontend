      ...
      <div className="bg-masala-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center text-white relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="btn-primary">Join Our Network</Link>
            <Link to="/menu" className="bg-white/10 text-white border border-white/20 px-8 py-3.5 rounded-full font-bold hover:bg-white/20 transition-all">Browse Tiffins</Link>
          </div>
        </div>
      </div>
    </div>
